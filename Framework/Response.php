...
final class Response {
   ...
   private function bufferPageView($fileName = null) {
      ...
      if(is_null($fileName)) {
         ...
         // TODO: Test order.
         $fileArray = array(
            APPROOT . DS . "PageView" . DS . DIR . DS . "_{$fileName}.html",
            APPROOT . DS . "PageView" . DS . FILE . DS . "_{$fileName}.html",
            APPROOT . DS . "PageView" . DS . BASEDIR . DS . "_{$fileName}.html",
            APPROOT . DS . "PageView" . DS . "_{$fileName}.html"
         );
      }
